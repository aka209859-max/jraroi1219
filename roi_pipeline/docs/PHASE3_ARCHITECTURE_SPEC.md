...
### 目的
Task 1〜3の全パイプラインを、2016年1月〜2025年12月の期間で月次ローリングWalk-Forwardにより検証する。
...
#### ローリング窓
```
学習窓: 36か月（例: 2016-01 ～ 2018-12 が初期学習窓）
検証窓: 1か月（例: 2019-01 が最初の検証月）
ステップ: 1か月ずつスライド

データ期間: 2016-01 開始 → 2025-12 終了
検証期間数: 84か月分（2019-01 ～ 2025-12 = 7年）
初期学習データ: 2016-2018の3年分（36か月）
```
...
- **データ取得期間: 2016-01-01 ～ 2025-12-31**（学習窓36か月分を含む）
